...
fun createModeration(): suspend BehaviourContext.(CommonMessage<TextContent>, Array<String>) -> Unit = tryF { message, args ->
    ...
    reply(message, poll.toMessage(langCode), replyMarkup = moderatorsReviewMarkup(id, poll.moderatorApproves.size))
}
